...
namespace School
{
    ...
    public partial class StudentForm : Window
    {
        ...
        private void ok_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show("The date of birth must be a valid date, DD-MM-YYYY", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
                return;
            }
            ...
            {
                MessageBox.Show("The student must be at least 5 years old or older", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
                return;
            }
