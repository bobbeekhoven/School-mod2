...
namespace School
{
    ...
    public partial class MainWindow : Window
    {
        ...
        // Exercise 1: Task 1a: If the user double-clicks a student, edit the details for that student
